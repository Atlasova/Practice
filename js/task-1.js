...
//if (name.toLowerCase() === 'ECMAScript'.toLocaleLowerCase()) {
//  alert('Вірно!');
//} else {
...
//Вирішення
//const login = promt('Введіть свій логін');
//if (login === 'Адмін') {
...
//let number = promt('Введіть число більше 100');
//while (number <= 100 && number !== null) {
//  number = promt('Введіть число більше 100')
//}
//console.log(number)
